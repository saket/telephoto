...
class ZoomableContentLocationTest {
  @Test fun `content size should only be referentially equatable`() {
    val size1 = ZoomableContentLocation.fitToBoundsAndAlignedToCenter(Size(10f, 10f))
    val size2 = ZoomableContentLocation.fitToBoundsAndAlignedToCenter(Size(10f, 10f))
